...
# load the model.pkl
# path = r'/Users/eesoonhang/Library/CloudStorage/OneDrive-Personal/06. DSSI/Day02/Code Base/ap3-main/model.pkl'
...
@st.cache_data() # check if the data already cache to avoid processing overhead for reloading
...
def main():
	...
	st.sidebar.info('Provide input using the panel') # with .sidebar, the label will go to the sidebar
	st.info('Click Assess button below')	# without .sidebar, the label will go to the main container
